...
const changeHolidayBackgroundColor = () => {
  const holiday = document.querySelectorAll('.holiday');
  holiday[0].style.backgroundColor = 'gray';
}

const changeHolidayBackgroundColorClicking = () => {
  const btnHoliday = document.querySelector('#btn-holiday');
  btnHoliday.addEventListener('click', changeHolidayBackgroundColor());
}
